...
--EXERCICIO 1 CRIANDO O TRIGGER
CREATE OR REPLACE TRIGGER stockRemoval 
...
--TESTANDO O TRIGGER
SELECT * FROM PRODUTO;
INSERT INTO PEDIDO VALUES (7, 1, TO_DATE('18/10/2020', 'DD/MM/YYYY'), 1600.00);
INSERT INTO ITEMPEDIDO VALUES (7, 1, 800.00, 1, 1);
INSERT INTO ITEMPEDIDO VALUES (7, 2, 800.00, 1, 3);
SELECT * FROM PRODUTO;

--EXERCICIO 2 CRIANDO SEQUENCIA PARA TABELA LOG
CREATE SEQUENCE Idlog  
    START WITH 1  
    INCREMENT BY 1 
    MAXVALUE 999999999 
    MINVALUE 1;
...
--TESTANDO O TRIGGER
EXEC insertProduct (7, 'SONY XPERIA L1', 10) ;
SELECT * FROM LOG ;